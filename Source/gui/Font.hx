	...
	public function new () {
		...
		var data:Array<Letter> = [
		  ...
		  // 0 - lowercase
			...
			new Letter("b", 0x01, 0.5 ),
			new Letter("c", 0x02, 0.5 ),
			new Letter("d", 0x03, 0.5 ),
			new Letter("e", 0x04, 0.5 ),
			new Letter("f", 0x05, 0.4 ),
			new Letter("g", 0x06, 0.5 ),
			new Letter("h", 0x07, 0.5 ),
			new Letter("i", 0x08, 0.3 ),
			new Letter("j", 0x09, 0.4 ),
			new Letter("k", 0x0A, 0.5 ),
			new Letter("l", 0x0B, 0.25),
			new Letter("m", 0x0C, 0.55 ),
			new Letter("n", 0x0D, 0.5 ),
			new Letter("o", 0x0E, 0.5 ),
			new Letter("p", 0x0F, 0.5 ),
			// 1 - lowercase
			new Letter("q", 0x10 ),
			new Letter("r", 0x11, 0.5 ),
			new Letter("s", 0x12 ),
			...
			new Letter("G", 0x26 ),
			new Letter("H", 0x27 ),
			new Letter("I", 0x28, 0.7 ),
			new Letter("J", 0x29 ),
			new Letter("K", 0x2A ),
			new Letter("L", 0x2B, 0.6 ),
			new Letter("M", 0x2C ),
			new Letter("N", 0x2D ),
			new Letter("O", 0x2E ),
			new Letter("P", 0x2F ),
